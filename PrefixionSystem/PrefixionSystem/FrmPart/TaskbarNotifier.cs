...
namespace PrefixionSystem.FrmPart
{
    public partial class TaskbarNotifier : Form
    {
        ...
        public RecordDetail recordDetail_;
        ...
        protected Rectangle RealMediumTypeRectangle;
        protected Rectangle RealUnhandledMsgRectangle;
        ...
        protected Color normalUnhandledMsgColor = Color.FromArgb(255, 0, 0);


        protected Font normalTitleFont = new Font("微软雅黑", 17F, FontStyle.Bold, GraphicsUnit.Pixel);
        protected Font hoverTitleFont = new Font("微软雅黑", 17F, FontStyle.Bold, GraphicsUnit.Pixel);
        protected Font normalContentFont = new Font("微软雅黑", 15F, FontStyle.Regular, GraphicsUnit.Pixel);
        protected Font hoverContentFont = new Font("微软雅黑", 15F, FontStyle.Regular, GraphicsUnit.Pixel);
        ...
        public Rectangle MediumTypeRectangle;
        public Rectangle UnhandledMsgRectangle;
        ...
        public delegate void MyEvent(RecordDetail recordinfo);
        public event MyEvent ContentClick;
        #endregion
        ...
        protected void DrawText(Graphics grfx)
        {
            ...
            if (MediumType != null && MediumType.Length != 0)
            {
                ...
                if (bIsMouseOverContent)
                {
                    grfx.DrawString(MediumType, hoverContentFont, new SolidBrush(hoverContentColor), MediumTypeRectangle, sf);
                    if (EnableSelectionRectangle)
                        ControlPaint.DrawBorder3D(grfx, RealMediumTypeRectangle, Border3DStyle.Etched, Border3DSide.Top | Border3DSide.Bottom | Border3DSide.Left | Border3DSide.Right);

                }
                else
                    grfx.DrawString(MediumType, normalContentFont, new SolidBrush(normalContentColor), MediumTypeRectangle, sf);
            }


            if (UnhandledMsg != null && UnhandledMsg.Length != 0)
            {
                StringFormat sf = new StringFormat();
                sf.Alignment = StringAlignment.Center;
                sf.LineAlignment = StringAlignment.Center;
                ...
                if (bIsMouseOverContent)
                {
                    grfx.DrawString(UnhandledMsg, hoverContentFont, new SolidBrush(hoverContentColor), UnhandledMsgRectangle, sf);
                    if (EnableSelectionRectangle)
                        ControlPaint.DrawBorder3D(grfx, RealUnhandledMsgRectangle, Border3DStyle.Etched, Border3DSide.Top | Border3DSide.Bottom | Border3DSide.Left | Border3DSide.Right);

                }
                else
                    grfx.DrawString(UnhandledMsg, normalContentFont, new SolidBrush(normalUnhandledMsgColor), UnhandledMsgRectangle, sf);
            }
        ...
        protected void CalculateMouseRectangles()
        {
            ...
            SizeF sizefMediumType = grfx.MeasureString(MediumType, hoverContentFont, MediumTypeRectangle.Width, sf);
            SizeF sizefUnhandledMsg = grfx.MeasureString(UnhandledMsg, hoverContentFont, UnhandledMsgRectangle.Width, sf);
            grfx.Dispose();
            ...
            //检测媒体类型矩形是否适合预置的媒体类型矩形
            if (sizefMediumType.Height > MediumTypeRectangle.Height)
            {
                RealMediumTypeRectangle = new Rectangle((MediumTypeRectangle.Width - (int)sizefMediumType.Width) / 2 + MediumTypeRectangle.Left, MediumTypeRectangle.Top, (int)sizefMediumType.Width, MediumTypeRectangle.Height);
            }
            else
            {
                RealMediumTypeRectangle = new Rectangle((MediumTypeRectangle.Width - (int)sizefMediumType.Width) / 2 + MediumTypeRectangle.Left, (MediumTypeRectangle.Height - (int)sizefMediumType.Height) / 2 + MediumTypeRectangle.Top, (int)sizefMediumType.Width, (int)sizefMediumType.Height);
            }
            RealMediumTypeRectangle.Inflate(0, 2);


            //检测未处理消息数量矩形是否适合预置的未处理消息数量矩形
            if (sizefUnhandledMsg.Height > UnhandledMsgRectangle.Height)
            {
                RealUnhandledMsgRectangle = new Rectangle((UnhandledMsgRectangle.Width - (int)sizefUnhandledMsg.Width) / 2 + UnhandledMsgRectangle.Left, UnhandledMsgRectangle.Top, (int)sizefUnhandledMsg.Width, UnhandledMsgRectangle.Height);
            }
            else
            {
                RealUnhandledMsgRectangle = new Rectangle((UnhandledMsgRectangle.Width - (int)sizefUnhandledMsg.Width) / 2 + UnhandledMsgRectangle.Left, (UnhandledMsgRectangle.Height - (int)sizefUnhandledMsg.Height) / 2 + UnhandledMsgRectangle.Top, (int)sizefUnhandledMsg.Width, (int)sizefUnhandledMsg.Height);
            }
            RealUnhandledMsgRectangle.Inflate(0, 2);
        }
